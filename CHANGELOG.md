...
- Support mixed book and subfolder directories through separate OPDS feeds.
- Add optional KOReader-specific mixed feeds.
- Add on-demand PDF first-page covers with a configurable disk cache.
